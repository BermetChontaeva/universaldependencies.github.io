...
A treebank may contain segments that belong to different parallel collections. Then there will be multiple `Parallel` lines in the treebank's README. Turkic TueCL-Treebanks example:
...
* Bible: Ancient Greek PROIEL, Ancient Greek PTNK, Ancient Hebrew, Coptic, Gothic, Latin PROIEL, Old Church Slavonic, Romanian Nonstandard, Yoruba, what else?
* Cairo: Latgalian, Latvian, Luxembourgish, Old English, Tswana, others have it as one part of larger data (Azerbaijani, Kyrgyz, Buryat, Macedonian, Malayalam, Turkish, Uzbek, what else?)
